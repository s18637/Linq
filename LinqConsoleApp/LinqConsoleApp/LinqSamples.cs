    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad2()
        {
            ...
            var res2 = Emps.Where(x => x.Job == "Frontend programmer" && x.Salary > 1000).OrderBy(x => x.Ename);
            foreach (var re in res2)
            {
                Console.WriteLine(re);
            }
        ...
        {
            var res = Emps.Where( x => x.Salary == Emps.Max(x=>x.Salary));
            foreach (var re in res)
            {
                Console.WriteLine(re);
            }
        ...
        {
            var res = Emps.Where(x => x.Job == "Frontend programmer").OrderByDescending(x => x.HireDate).Take(1);
            foreach (var re in res)
            {
                Console.WriteLine(re);
            }
        ...
        {
            var res = Emps.Aggregate((x, next) => next.Salary > x.Salary ? next : x);
            Console.WriteLine(res);
